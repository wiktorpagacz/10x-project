...
describe("CharacterCounter", () => {
  ...
  describe("Status indication", () => {
    it("should show valid status when within limits", () => {
      const { container } = render(<CharacterCounter current={500} max={1000} threshold={70} />);
    ...
    it("should show warning status when approaching threshold", () => {
      const { container } = render(<CharacterCounter current={750} max={1000} threshold={70} />);
    ...
    it("should show error status when exceeding max", () => {
      const { container } = render(<CharacterCounter current={1100} max={1000} />);
    ...
    it("should show error status when below minimum", () => {
      const { container } = render(<CharacterCounter current={500} max={10000} min={1000} />);
  ...
  describe("Edge cases", () => {
    ...
    it("should handle exact max limit", () => {
      const { container } = render(<CharacterCounter current={1000} max={1000} threshold={70} />);
    ...
    it("should handle exact min limit", () => {
      const { container } = render(<CharacterCounter current={1000} max={10000} min={1000} />);
    ...
    it("should handle custom threshold", () => {
      const { container } = render(<CharacterCounter current={850} max={1000} threshold={80} />);
