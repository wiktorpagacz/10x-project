...
describe("GenerateButton", () => {
  describe("Rendering", () => {
    it('should render with default "Generate Flashcards" text', () => {
      render(<GenerateButton isDisabled={false} isLoading={false} onClick={vi.fn()} />);
    ...
    it("should render Sparkles icon when not loading", () => {
      const { container } = render(<GenerateButton isDisabled={false} isLoading={false} onClick={vi.fn()} />);
    ...
    it("should render loading state with spinner", () => {
      render(<GenerateButton isDisabled={false} isLoading={true} onClick={vi.fn()} />);
    ...
    it("should render Loader2 icon with spin animation when loading", () => {
      const { container } = render(<GenerateButton isDisabled={false} isLoading={true} onClick={vi.fn()} />);
  ...
  describe("Disabled state", () => {
    it("should be disabled when isDisabled is true", () => {
      render(<GenerateButton isDisabled={true} isLoading={false} onClick={vi.fn()} />);
    ...
    it("should be disabled when both isDisabled and isLoading are true", () => {
      render(<GenerateButton isDisabled={true} isLoading={true} onClick={vi.fn()} />);
  ...
  describe("User interactions", () => {
    it("should call onClick when clicked and enabled", async () => {
      ...
      render(<GenerateButton isDisabled={false} isLoading={false} onClick={handleClick} />);
    ...
    it("should not call onClick when disabled", async () => {
      ...
      render(<GenerateButton isDisabled={true} isLoading={false} onClick={handleClick} />);
    ...
    it("should not call onClick when loading", async () => {
      ...
      render(<GenerateButton isDisabled={false} isLoading={true} onClick={handleClick} />);
