    ...
    <AlertDialog open={isOpen} onOpenChange={(open) => !open && onCancel()}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            You have flashcards that haven&apos;t been saved to your collection yet. If you leave now, your changes will
            be lost. Are you sure you want to discard these flashcards?
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
          <AlertDialogCancel onClick={onCancel}>Keep Reviewing</AlertDialogCancel>
          <AlertDialogAction
            onClick={onConfirm}
